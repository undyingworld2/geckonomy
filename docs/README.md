...
8. **[ROADMAP.md](ROADMAP.md)** — milestones M0–M11 + future, acceptance criteria.
9. **[CODING_STANDARDS.md](CODING_STANDARDS.md)** — Kotlin style, layering, testing rules.

## For coding agents
Each milestone has a self-contained task spec in **[tasks/](tasks/)** (`M0`…`M11`; `M11` is planned,
post-v1). Take one milestone at a time, in order; each lists files to create, implementation
